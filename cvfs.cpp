...
void man(char *name)
{
    ...
    {
        printf("Description:used to creat enew regular file\n");
        printf("usage:create file_name permission\n");
    }
    else if(strcmp(name,"read")==0)
    {
        printf("Description:used to read data from regular file\n");
        printf("usage:read file_name No_Of_Byted_To_Read\n");
    }
...
void DisplayHelp()
{
    ...
    printf("write:to write contents in to the file\n");
    printf("exit:to terminate file system\n ");
    printf("stat:to Display information of file using descriptor\n");
...
{
     if(((UFDTArr[fd].ptrfiletable->mode)!=WRITE && (UFDTArr[fd].ptrfiletable->mode)!=READ+WRITE)) return -2;
          ...
          if (strcmp(command[0],"stat")==0)
           {
            ...
            if(ret==-1)
                printf("ERROR:Incorrevt Parameters\n");
             if(ret==-2)
